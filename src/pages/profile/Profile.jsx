...
function Profile() {
  ...
  const onSubmit = (data) => {
    axios.put(`${BASE_URL}/auth/me`, data, {
      ...
      <div className="font-[Poppins] bg-grey-lighter min-h-screen flex flex-col">
        <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
          <form className="bg-white px-6 py-8  rounded-xl shadow-md text-black w-full">
            ...
            <div
              className={`${
                errors.first_name?.type === "required" ? "block" : "hidden"
            ...
            <div
              className={`${
                errors.email?.type === "required" ? "block" : "hidden"
              } bg-red-100 border border-red-400 text-red-700 px-4 py-3  rounded-xl relative`}
              role="alert"
            >
            ...
            <div
              className={`${
                errors.email?.type === "pattern" ? "block" : "hidden"
              } bg-red-100 border border-red-400 text-red-700 px-4 py-3  rounded-xl relative`}
              role="alert"
            >
            ...
            <div
              className={`${
                errors.phone_number?.type === "required" ? "block" : "hidden"
              } bg-red-100 border border-red-400 text-red-700 px-4 py-3  rounded-xl relative`}
              role="alert"
            >
            ...
            <div
              className={`${
                errors.phone_number?.type === "pattern" ? "block" : "hidden"
              } bg-red-100 border border-red-400 text-red-700 px-4 py-3  rounded-xl relative`}
              role="alert"
            >
