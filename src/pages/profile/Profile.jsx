            ...
            <div className="bg-grey-lighter min-h-screen flex flex-col">
                <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
                    <form className="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                        ...
                        />
                        <div className={`${errors.phone_number?.type === 'required' ? 'block' : 'hidden'} bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative`}
                             role="alert">
                            <span className="block sm:inline">Phone Number Is Required</span>
                        </div>
                        <div className={`${errors.phone_number?.type === 'pattern' ? 'block' : 'hidden'} bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative`}
                             role="alert">
                    ...
                    <div className="text-grey-dark mt-6">
                        <Link to='/address' className="no-underline border-b border-blue text-blue">
                        Edit Address &nbsp;
                        </Link>
                    </div>
                </div>
