...
const Navbar = ({ loading, query }) => {
  ...
  return (
    <div className=" w-full z-50 bg-white fixed h-20 top-0 left-0">
      {loading ? null : (
        <div className="w-full z-50 bg-[#DFEBEC] shadow fixed h-20 top-0 ">
          <div className="font-[Poppins] lg:flex items-center justify-between py-2 lg:px-10 px-7">
            ...
            <ul
              className={`lg:flex lg:items-center lg:pb-0 pb-12 absolute lg:static bg-[#DFEBEC] lg:z-auto z-[-1]
                 left-0 w-full lg:w-auto lg:pl-0 transition-all duration-500 ease-in ${
            ...
            >
              <div className="relative lg:hidden mt-2">
                <input
                  placeholder="SEARCH"
                  className="w-80  rounded-2xl pl-3 py-2
                ...
                <Link to="/products">
                  <img
                    ...
                    src={search}
                    className={`${
                      open ? "top-1 " : "top-[-300px]"
                    } absolute  lg:hidden right-14
            ...
            <div className="relative hidden lg:block">
              <input
                placeholder="SEARCH"
                className="w-96 rounded-2xl pl-3 py-2 hidden lg:block
                                          focus:outline-none focus:ring focus:ring-cyan-500 border"
                type="search"
                onChange={(e) => query(e.target.value)}
                onKeyDown={handleKeyDown}
              ...
              <Link to="/products">
                <img
                  alt=""
                  src={search}
                  className={` absolute transition-all top-2 right-2 w-7 hover:cursor-pointer`}
                />
              </Link>
            </div>
            <div className="flex -mt-14 lg:mt-0 lg:block absolute right-0 lg:relative">
              ...
              <Link
                to="/wishlist"
                className={"w-8 -mb-3 mr-6 hidden lg:inline-block"}
              >
                <svg
                  style={{
                    color: "rgb(57, 129, 141)",
                    width: "30px",
                    height: "30px",
                  }}
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Link
                to="/cart"
                className={"w-8 -mb-2 mr-6 inline-block relative"}
              >
